            ...
            <div className="col-sm-8">
                ...
                <div className="row mt-5">
                    ...
                    project.gallery.map((gallery, i) => 
                        ...
                        {
                            gallery.type === "image" ? 
                            <img className="p-3 img-fluid" src={"/assets/papers/mrmac/"+gallery.url} alt="" /> : 
                            <div className="py-1">
                                <b>{gallery.header}</b>
                        ...
                        <div className="col-6">
                            <div className="d-flex paper-thumbnail-box">
                                ...
                                <div className="d-flex flex-column justify-content-center">
                                    <a className="nav-linkn text-left text-decoration-underline" href={"/assets/papers/"+slide.pdf} target="_blank">
                ...
                {project.articles && (
                    <React.Fragment>
                    <div className="col-12"><b>News</b></div>

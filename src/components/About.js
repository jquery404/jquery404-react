      ...
      <div className='row'>
        <div className='col-sm-7'>
          <div className='py-5'>
            ...
            <p className='my-5'>
              I develop software for all sorts of platforms (<i className='fab fa-windows'></i> /{' '}
              <i className='fab fa-apple'></i> / <i className='fab fa-linux'></i>) using different tools depending on
              the <Link to='/project'>project</Link> needs (<i className='fab fa-react'></i> /{' '}
              <i className='fab fa-angular'></i> / <i className='fab fa-android'></i> / <i className='fab fa-unity'></i>
              ).
              <br />
              <br />I received my Ph.D. in computer graphics from Victoria University of Wellington, New Zealand, and
              I'm also an AWS Certified{' '}
              ...
              <i className='fas fa-vr-cardboard'></i>) tools and getting lost in my thoughts about coding standards,
              design methodologies, usability, and accessibility.
              <br />
              <br />
